...
export default function Home() {
  return (
    <main className="min-h-screen">
      <header className="w-full flex justify-between items-center fixe p-5 border border-b-1 border-gray-300 h-20">
        <div className="ml-5">
          <Image
            src="/aiesecLogo.svg"
            alt="Vercel Logo"
      ...
      {/* about */}
      <div className="">
        <div className="text-3xl font-semibold text-center mt-9">
          About Aiesec Surabaya
        </div>
        <p className="text-center text-2xl px-96 mt-10">
          AIESEC is a global youth-led organization striving to achieve peace
          and fulfillment of humankind’s potential by activating leadership
          qualities in youth. AIESEC spreads across 106 nations and territories,
          including Indonesia. AIESEC in Indonesia established in 1984 aims to
          develop youth to make a better Indonesia right now and in the future.
        </p>
        <div className="text-center text-2xl font-semibold mt-10 text-blue-500">
          Know Us More
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-5 px-56 mt-10">
      ...
      {/* partner with us ? */}
      <div className="flex justify-center gap-10 mt-10 px-44">
        <div className="w-1/2">
          <div className="text-3xl font-semibold text-center">
            Partner With Us?
          </div>
          <div className="h-1 w-48 bg-blue-500 my-5" />
          <p>
          ...
          >
            <div className="w-full lg:full lg:mx-auto">
              ...
              <div className="w-full text-center">
                <button className="bg-blue-500 text-base font-semibold text-white bg-green-main py-1 px-9 rounded-full sm:w-32 lg:w-60 xl:w-72 hover:opacity-80 hover:shadow-lg transition duration-500">
                  Send
                </button>
              </div>
            </div>
      ...
      <div className="flex bg-gray-900 p-10 mt-10">
        <div className="grid grid-cols-3 gap-10 px-28">
          ...
          {/* journey */}
          <div className="ml-24">
            <div className="text-2xl text-blue-500">Our Journey</div>
          ...
          {/* office map */}
          <div className="">
            <div className="text-xl text-blue-500">Sosial Media</div>
            ...
            <div className="text-2xl text-blue-500 mt-10">
